  ...
  return (
    <div className="min-h-screen bg-blue-50 p-8">
      ...
      <main className="mt-8 w-3/4 mx-auto">
        <form className="bg-red-100 p-8 rounded-xl shadow-lg">
          ...
          {/* Streak Title */}
          <div className="mb-4">
            <label className="block text-red-800 font-semibold mb-2" htmlFor="streakTitle">
              Streak Title:
            </label>
            <input
              type="text"
              id="streakTitle"
              className="w-full border border-red-300 rounded-lg p-3 bg-white focus:outline-none focus:border-red-500"
          ...
          {/* Streak Type */}
          <div className="mb-4">
            <label className="block text-red-800 font-semibold mb-2" htmlFor="streakType">
              Streak Type:
            </label>
            <input
              type="text"
          ...
          {/* Goal Description */}
          <div className="mb-4">
            <label className="block text-red-800 font-semibold mb-2" htmlFor="goalDescription">
              Goal Description:
            </label>
            <input
              type="text"
